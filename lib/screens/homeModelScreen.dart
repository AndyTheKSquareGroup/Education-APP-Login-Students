...
import 'package:sixtheducation/screens/getInfoEventHomeScreen.dart';
        ...
        child: _event.length == 0
            ? Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                        "Welcome STUDENT NAME to new App powered by KSquare Education Institute.",
                        style: TextStyle(fontSize: 20, color: Colors.black),
                        textAlign: TextAlign.center),
                    Container(
                      child: Column(
                        children: [
                          Text("Press to view activities.",
                              style:
                    ...
                    child: Column(
                      ...
                      children: [
                        ListTile(
                          ...
                          onTap: () {
                            Get.to(
                              RequestLogicCalendarScreen(
                                titleEvent: _event[index]['title']['rendered'],
                            ...
                            children: [
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text("${_event[index]['date']} Published."),
